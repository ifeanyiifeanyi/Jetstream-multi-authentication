...
@section('title', 'Edit Job | '. ucwords($job->title))
@section('css')
                    ...
                    <div class="card card-info p-3">
                        ...
                        <form method="post" action="{{ route('job.update', $job->id) }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="location" class="form-control" id="location"
                                                placeholder="Enter location" value="{{ $job->location }}">
                                        </div>
                                        @error('location')
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="email" name="email" class="form-control" id="email"
                                                placeholder="Email" value="{{ $job->email }}">
                                        </div>
                                        @error('email')
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="skills" class="form-control" id="skills"
                                                placeholder="Enter skills" value="{{ $job->skills }}">
                                        </div>
                                        @error('skills')
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="requirements" class="form-control" id="requirements"
                                                placeholder="Enter Requirements">{{ $job->requirements }}</textarea>
                                        </div>
                                        @error('requirements')
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea name="others" class="form-control" id="others">{{ $job->others }}</textarea>
                                        </div>
                                        @error('others')
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                        @enderror
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <label for="image">
                                            @if(!$job->image)
                                                Image <small class="text-secondary">Optional</small>
                                            @else
                                            
                                                <img src="{{ asset($job->image) }}" style="width
                                                100px;height:100px" alt="" class="img-fluid img-responsive">
                                            @endif
                                        </label>
                                ...
                                <div class="form-check">
                                    <input {{ $job->status ? 'checked' : '' }} type="checkbox" name="status" class="form-check-input" id="status">
                            ...
                            <div class="card-footer">
                                <button type="submit" style="width:100% !important" class="btn btn-info btn-lg">Update</button>
                            </div>
                        </form>
                    </div>
                </div>
